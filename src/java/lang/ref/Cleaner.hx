 ...
 */
@:overload static public function create(): Cleaner;
/**
 ...
 *               create or start the thread.
 */
	@:overload static public function create(threadFactory:java.util.concurrent.ThreadFactory): Cleaner;
/**
 ...
 */
	public function register(obj:Dynamic,action:java.lang.Runnable):Cleaner_Cleanable;

}

@:native("java.lang.ref.Cleaner.Cleanable")
/**
 * {@code Cleanable} represents an object and a
 * cleaning action registered in a {@code Cleaner}.
 * @since 9
 */
extern interface Cleaner_Cleanable
{
/**
